...
<Library LVVersion="21008000">
	...
	<Item Name="Analog Input.lvclass" Type="LVClass" URL="../Voltage Input/Analog Input.lvclass"/>
	<Item Name="Analog Output.lvclass" Type="LVClass" URL="../Voltage Output/Analog Output.lvclass"/>
